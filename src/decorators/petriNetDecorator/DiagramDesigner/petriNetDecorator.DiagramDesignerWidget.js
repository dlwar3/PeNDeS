...
define([
    ...
    'text!./petriNetDecorator.DiagramDesignerWidget.html',
    'css!./petriNetDecorator.DiagramDesignerWidget.css'
], function (CONSTANTS, nodePropertyNames, DiagramDesignerWidgetDecoratorBase, petriNetDecoratorTemplate) {
    ...
    function petriNetDecorator(options) {
       ...
       // this.$resultIndicator = $('<span>', {text: 'Will indicate result'});
    }

    _.extend(petriNetDecorator.prototype, DiagramDesignerWidgetDecoratorBase.prototype);
    petriNetDecorator.prototype.DECORATORID = DECORATOR_ID;

    /*********************** OVERRIDE DiagramDesignerWidgetDecoratorBase MEMBERS **************************/

    petriNetDecorator.prototype.$DOMBase = $(petriNetDecoratorTemplate);
    ...
    petriNetDecorator.prototype.on_addTo = function () {
        ...
        this._checkForResult(this._control._client, this._control._client.getNode(this._metaInfo[CONSTANTS.GME_ID]));
    };

    petriNetDecorator.prototype._renderName = function () {
    ...
    petriNetDecorator.prototype._checkForResult = function(client, nodeObj) {
        var self = this,
        assetHash = nodeObj.getAttribute('name');

        if (assetHash) {
           // this.$resultIndicator.text('Has code');
        }
        else {
           // this.$resultIndicator.text('No result');
        }
        
    };

    petriNetDecorator.prototype.getConnectionAreas = function (id /*, isEnd, connectionMetaInfo*/) {
        var result = [],
            edge = 10,
            LEN = 20;
    ...
    petriNetDecorator.prototype._onNodeTitleChanged = function (oldValue, newValue) {
        var client = this._control._client;
    ...
    petriNetDecorator.prototype.doSearch = function (searchDesc) {
